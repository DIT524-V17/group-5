...
import group5.marbleapp.ActivitySecond;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    btService.mainActivity = MainActivity.this;
                    btService.scanCallback = MainActivity.this.getClass()
                        .getMethod("updateMap", new Class[]{ ScanResult.class });
                    btService.automaticSteeringCallback = MainActivity.this.getClass()
